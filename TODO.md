# TODO - polymarket-5min-bot

Repository: https://github.com/RanaPriyansh/polymarket-5min-bot.git
Canonical local path: /root/git-repos/polymarket-5min-bot
...
3. Run the local setup path for polymarket-5min-bot and write exact commands back into README if they are missing or stale.
