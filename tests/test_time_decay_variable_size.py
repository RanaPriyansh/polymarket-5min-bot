...
class TimeDecayVariableSizeTests(unittest.TestCase):
    ...
    def test_config_keeps_time_decay_scanner_only_after_negative_pnl(self):
        ...
        self.assertEqual(cfg["strategies"]["states"]["time_decay"], "scanner_only")
        self.assertIn("time_decay", cfg["strategies"]["candidates"])
